function [idx_wi_rem,idx_wi_forg,idx_bi_rem,idx_bi_forg,include_item]=get_idx_SME_spacing(subs)
%subs=1;
%m=2;
basedir='/seastor/helenhelen/ES';
labeldir=[basedir,'/behavior/label'];
rdir=sprintf('%s/Searchlight_RSM/native_space/sep/SME_spacing',basedir);
...
all_lable=[];
	...
	tmp=sortrows(list_cons,MAonset);
        twice_rep=tmp;
